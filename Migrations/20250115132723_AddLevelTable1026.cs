...
{
    /// <inheritdoc />
    public partial class AddLevelTable1026 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdMaterial = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IdTopic = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_Levels_IdLevel",
                        column: x => x.IdLevel,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Materials_Topics_IdTopic",
                        column: x => x.IdTopic,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_IdLevel",
                table: "Materials",
                column: "IdLevel");

            migrationBuilder.CreateIndex(
                name: "IX_Materials_IdTopic",
                table: "Materials",
                column: "IdTopic");
